...
# CONSTANTS
DAG_ID = "silver_movies_elicitation"
SPARK_SUBMIT = "/opt/spark/bin/spark-submit"
SPARK_JOB = "/opt/spark/app/processing/spark/jobs/movie_elicitation/main.py"
...
with DAG(
    ...
    check_bronze = S3KeySensor(
        ...
        bucket_name = "bronze", 
        bucket_key = "batch/movie_elicitation_set/*",
        wildcard_match = True,
        ...
        soft_fail = True,
        doc_md = (
            "Verifica se ha objetos em s3://bronze/batch/movie_elicitation_set/. "
    ...
    run_spark = DockerOperator(
        ...
        force_pull = False,
        doc_md = (
            "Executa spark-submit do job movie_elicitation dentro de um container"
            "Produz silver.movie_elicitation_set e silver.elicitation_features - Delta merge"
