...
SPARK_JOB = "/opt/spark/app/processing/spark/jobs/recommendation_history/main.py"
...
with DAG(
    dag_id = DAG_ID,
    description = "Pipeline Bronze -> Silver: recommendation_history e recommendation_features",
    ...
    check_bronze = S3KeySensor(
        ...
        bucket_name = "bronze",
        bucket_key = "streaming/user_recommendation_history/*",
        wildcard_match = True,
        ...
        soft_fail = True,
        doc_md = (
            "Verifica se ha objetos em s3://bronze/streaming/user_recommendation_history/. "
    ...
    run_spark = DockerOperator(
        ...
        force_pull = False,
        doc_md = (
            "Executa spark-submit do job recommendation_history dentro de um container. "
            "Produz silver.recommendation_history e silver.recommendation_features - Delta merge"
