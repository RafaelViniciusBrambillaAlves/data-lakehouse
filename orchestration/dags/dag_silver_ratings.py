...
SPARK_JOB = "/opt/spark/app/processing/spark/jobs/ratings/main.py"
...
with DAG(
    ...
    check_bronze = S3KeySensor(
        ...
        bucket_name = "bronze",
        bucket_key = "streaming/ratings_for_additional_users/*",
        wildcard_match = True,
        ...
        soft_fail = True,
        doc_md = (
            "Verifica se ha objetos em s3://bronze/streaming/ratings_for_additional_users/. "
    ...
    run_spark = DockerOperator(
        ...
        force_pull = False,
        doc_md = (
            "Executa spark-submit do job ratings dentro de um container. "
            "Produz silver.ratings - Delta merge. "
